...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_apihandler_t, stringdata) + ofs \
...
const QMetaObject apihandler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_apihandler.data,
      qt_meta_data_apihandler,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *apihandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_apihandler.stringdata))
        return static_cast<void*>(const_cast< apihandler*>(this));
    if (!strcmp(_clname, "enable_singleton<apihandler>"))
        return static_cast< enable_singleton<apihandler>*>(const_cast< apihandler*>(this));
